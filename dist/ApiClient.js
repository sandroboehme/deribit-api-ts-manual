...
class ApiClient {
    constructor() {
        ...
        if (typeof window === 'undefined') {
            this.agent = new superagent_1.default.agent();
        }
        /*
    ...
    callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType, apiBasePath, callback) {
        ...
        var request = (0, superagent_1.default)(httpMethod, url);
        ...
        if (contentType === 'application/x-www-form-urlencoded') {
            request.send(querystring_1.default.stringify(this.normalizeParams(formParams)));
        }
