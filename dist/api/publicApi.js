...
exports.PublicApi = exports.PublicApiApiKeys = void 0;
...
// ===============================================
var PublicApiApiKeys;
(function (PublicApiApiKeys) {
})(PublicApiApiKeys || (exports.PublicApiApiKeys = PublicApiApiKeys = {}));
class PublicApi {
     ...
     */
    publicAuthGet(grantType, username, password, clientId, clientSecret, refreshToken, timestamp, signature, nonce, state, scope, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (grantType !== undefined) {
                localVarQueryParameters['grant_type'] = models_1.ObjectSerializer.serialize(grantType, "'password' | 'client_credentials' | 'client_signature' | 'refresh_token'");
            }
            ...
            if (clientId !== undefined) {
                localVarQueryParameters['client_id'] = models_1.ObjectSerializer.serialize(clientId, "string");
            }
            if (clientSecret !== undefined) {
                localVarQueryParameters['client_secret'] = models_1.ObjectSerializer.serialize(clientSecret, "string");
            }
            if (refreshToken !== undefined) {
                localVarQueryParameters['refresh_token'] = models_1.ObjectSerializer.serialize(refreshToken, "string");
            }
            if (timestamp !== undefined) {
                localVarQueryParameters['timestamp'] = models_1.ObjectSerializer.serialize(timestamp, "string");
            }
            if (signature !== undefined) {
                localVarQueryParameters['signature'] = models_1.ObjectSerializer.serialize(signature, "string");
            }
            if (nonce !== undefined) {
                localVarQueryParameters['nonce'] = models_1.ObjectSerializer.serialize(nonce, "string");
            }
            if (state !== undefined) {
     ...
     */
    publicGetBookSummaryByCurrencyGet(currency, kind, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetBookSummaryByInstrumentGet(instrumentName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param instrumentName Instrument name
     */
    publicGetContractSizeGet(instrumentName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetCurrenciesGet(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetFundingChartDataGet(instrumentName, length, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (length !== undefined) {
                localVarQueryParameters['length'] = models_1.ObjectSerializer.serialize(length, "'8h' | '24h'");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     * @param currency The currency symbol
     */
    publicGetHistoricalVolatilityGet(currency, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param currency The currency symbol
     */
    publicGetIndexGet(currency, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetInstrumentsGet(currency, kind, expired, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (expired !== undefined) {
                localVarQueryParameters['expired'] = models_1.ObjectSerializer.serialize(expired, "boolean");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     */
    publicGetLastSettlementsByCurrencyGet(currency, type, count, continuation, searchStartTimestamp, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (continuation !== undefined) {
                localVarQueryParameters['continuation'] = models_1.ObjectSerializer.serialize(continuation, "string");
            }
            if (searchStartTimestamp !== undefined) {
                localVarQueryParameters['search_start_timestamp'] = models_1.ObjectSerializer.serialize(searchStartTimestamp, "number");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     * @param searchStartTimestamp The latest timestamp to return result for
     */
    publicGetLastSettlementsByInstrumentGet(instrumentName, type, count, continuation, searchStartTimestamp, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetLastTradesByCurrencyAndTimeGet(currency, startTimestamp, endTimestamp, kind, count, includeOld, sorting, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByCurrencyGet(currency, kind, startId, endId, count, includeOld, sorting, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByInstrumentAndTimeGet(instrumentName, startTimestamp, endTimestamp, count, includeOld, sorting, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByInstrumentGet(instrumentName, startSeq, endSeq, count, includeOld, sorting, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetOrderBookGet(instrumentName, depth, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetTimeGet(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicGetTradeVolumesGet(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param endTimestamp The most recent timestamp to return result for
     */
    publicGetTradingviewChartDataGet(instrumentName, startTimestamp, endTimestamp, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    publicTestGet(expectedResult, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (expectedResult !== undefined) {
                localVarQueryParameters['expected_result'] = models_1.ObjectSerializer.serialize(expectedResult, "'exception'");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     * @param instrumentName Instrument name
     */
    publicTickerGet(instrumentName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
