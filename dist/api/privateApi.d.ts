...
export declare enum PrivateApiApiKeys {
}
export declare class PrivateApi {
    ...
    setApiKey(key: PrivateApiApiKeys, value: string): void;
     ...
     */
    privateAddToAddressBookGet(currency: 'BTC' | 'ETH', type: 'transfer' | 'withdrawal', address: string, name: string, tfa?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param tfa TFA code, required when TFA is enabled for current account
     */
    privateCancelTransferByIdGet(currency: 'BTC' | 'ETH', id: number, tfa?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateCancelWithdrawalGet(currency: 'BTC' | 'ETH', id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateChangeSubaccountNameGet(sid: number, name: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param currency The currency symbol
     */
    privateCreateDepositAddressGet(currency: 'BTC' | 'ETH', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateCreateSubaccountGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param sid The user id for the subaccount
     */
    privateDisableTfaForSubaccountGet(sid: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateDisableTfaWithRecoveryCodeGet(password: string, code: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateGetAccountSummaryGet(currency: 'BTC' | 'ETH', extended?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param type Address book type
     */
    privateGetAddressBookGet(currency: 'BTC' | 'ETH', type: 'transfer' | 'withdrawal', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param currency The currency symbol
     */
    privateGetCurrentDepositAddressGet(currency: 'BTC' | 'ETH', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateGetDepositsGet(currency: 'BTC' | 'ETH', count?: number, offset?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateGetEmailLanguageGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateGetNewAnnouncementsGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param instrumentName Instrument name
     */
    privateGetPositionGet(instrumentName: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateGetPositionsGet(currency: 'BTC' | 'ETH', kind?: 'future' | 'option', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param withPortfolio
     */
    privateGetSubaccountsGet(withPortfolio?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param offset The offset for pagination, default - &#x60;0&#x60;
     */
    privateGetTransfersGet(currency: 'BTC' | 'ETH', count?: number, offset?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param offset The offset for pagination, default - &#x60;0&#x60;
     */
    privateGetWithdrawalsGet(currency: 'BTC' | 'ETH', count?: number, offset?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param tfa TFA code, required when TFA is enabled for current account
     */
    privateRemoveFromAddressBookGet(currency: 'BTC' | 'ETH', type: 'transfer' | 'withdrawal', address: string, tfa?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateSetAnnouncementAsReadGet(announcementId: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateSetEmailForSubaccountGet(sid: number, email: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateSetEmailLanguageGet(language: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param password The password for the subaccount
     */
    privateSetPasswordForSubaccountGet(sid: number, password: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateSubmitTransferToSubaccountGet(currency: 'BTC' | 'ETH', amount: number, destination: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param tfa TFA code, required when TFA is enabled for current account
     */
    privateSubmitTransferToUserGet(currency: 'BTC' | 'ETH', amount: number, destination: string, tfa?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param state
     */
    privateToggleDepositAddressCreationGet(currency: 'BTC' | 'ETH', state: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateToggleNotificationsFromSubaccountGet(sid: number, state: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    privateToggleSubaccountLoginGet(sid: number, state: 'enable' | 'disable', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param tfa TFA code, required when TFA is enabled for current account
     */
    privateWithdrawGet(currency: 'BTC' | 'ETH', address: string, amount: number, priority?: 'insane' | 'extreme_high' | 'very_high' | 'high' | 'mid' | 'low' | 'very_low', tfa?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=privateApi.d.ts.map