...
export declare enum MarketDataApiApiKeys {
}
export declare class MarketDataApi {
    ...
    setApiKey(key: MarketDataApiApiKeys, value: string): void;
...
//# sourceMappingURL=marketDataApi.d.ts.map