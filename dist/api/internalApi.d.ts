...
export declare enum InternalApiApiKeys {
}
export declare class InternalApi {
    ...
    setApiKey(key: InternalApiApiKeys, value: string): void;
     ...
     * @param currency The currency symbol
     */
    publicGetOptionMarkPricesGet(currency: 'BTC' | 'ETH', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
