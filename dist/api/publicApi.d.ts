...
export declare enum PublicApiApiKeys {
}
export declare class PublicApi {
    ...
    setApiKey(key: PublicApiApiKeys, value: string): void;
     ...
     */
    publicAuthGet(grantType: 'password' | 'client_credentials' | 'client_signature' | 'refresh_token', username: string, password: string, clientId: string, clientSecret: string, refreshToken: string, timestamp: string, signature: string, nonce?: string, state?: string, scope?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetAnnouncementsGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetBookSummaryByCurrencyGet(currency: 'BTC' | 'ETH', kind?: 'future' | 'option', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetBookSummaryByInstrumentGet(instrumentName: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param instrumentName Instrument name
     */
    publicGetContractSizeGet(instrumentName: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetCurrenciesGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetFundingChartDataGet(instrumentName: string, length?: '8h' | '24h', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param currency The currency symbol
     */
    publicGetHistoricalVolatilityGet(currency: 'BTC' | 'ETH', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param currency The currency symbol
     */
    publicGetIndexGet(currency: 'BTC' | 'ETH', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetInstrumentsGet(currency: 'BTC' | 'ETH', kind?: 'future' | 'option', expired?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetLastSettlementsByCurrencyGet(currency: 'BTC' | 'ETH', type?: 'settlement' | 'delivery' | 'bankruptcy', count?: number, continuation?: string, searchStartTimestamp?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param searchStartTimestamp The latest timestamp to return result for
     */
    publicGetLastSettlementsByInstrumentGet(instrumentName: string, type?: 'settlement' | 'delivery' | 'bankruptcy', count?: number, continuation?: string, searchStartTimestamp?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetLastTradesByCurrencyAndTimeGet(currency: 'BTC' | 'ETH', startTimestamp: number, endTimestamp: number, kind?: 'future' | 'option', count?: number, includeOld?: boolean, sorting?: 'asc' | 'desc' | 'default', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByCurrencyGet(currency: 'BTC' | 'ETH', kind?: 'future' | 'option', startId?: string, endId?: string, count?: number, includeOld?: boolean, sorting?: 'asc' | 'desc' | 'default', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByInstrumentAndTimeGet(instrumentName: string, startTimestamp: number, endTimestamp: number, count?: number, includeOld?: boolean, sorting?: 'asc' | 'desc' | 'default', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
     */
    publicGetLastTradesByInstrumentGet(instrumentName: string, startSeq?: number, endSeq?: number, count?: number, includeOld?: boolean, sorting?: 'asc' | 'desc' | 'default', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetOrderBookGet(instrumentName: string, depth?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicGetTradeVolumesGet(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param endTimestamp The most recent timestamp to return result for
     */
    publicGetTradingviewChartDataGet(instrumentName: string, startTimestamp: number, endTimestamp: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicTestGet(expectedResult?: 'exception', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param instrumentName Instrument name
     */
    publicTickerGet(instrumentName: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    publicValidateFieldGet(field: string, value: string, value2?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
